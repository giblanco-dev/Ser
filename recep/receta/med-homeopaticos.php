...
$sql_val_med_cap = "SELECT *, CONCAT(med1,', ',med2,', ',med3,', ',med4,', ',med5) MedFrascos FROM rec_med_home WHERE tipo_fras = 'gen' AND id_cita = '$cita' and (cancelado = 0 OR cancelado is null);";
