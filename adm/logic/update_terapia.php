...
if(!empty($_GET)){
$id_registro = $_GET['id_terapia'];
$sql_actualiza = "SELECT * FROM terapias WHERE id_terapia =  '$id_registro'";
...
if(!empty($_POST)){
  ...
  $descrip_terapia = $_POST['descripcion'];
  $costo_terapia = $_POST['precio'];
  $id_terapia2 = $_POST['id_actualiza'];
  $max = $_POST['max'];
  

  $sql_update = "UPDATE terapias SET nom_terapia = '$descrip_terapia', precio = '$costo_terapia', max_terapias = '$max' WHERE id_terapia = '$id_terapia2'";
...
<head>
    ...
    <title>Actualización::Terapias</title>
    ...
    <div class="col-s12 center-align">
            ...
            while($row = mysqli_fetch_assoc($result_sql) ){ ?>
                ...
                <div class="row center-align">
                  <div class="col s6">
                    <p>Terapia</p>
                    <input type="text" name="descripcion" value="<?php echo $row['nom_terapia']; ?>">
                  </div>
                  <div class="col s3">
                    <p>Precio Terapia</p>
                  ...
                  <div class="col s3">
                    <p>Máx. Terapias</p>
                    <input type="number" name="max" value="<?php echo $row['max_terapias']; ?>">
                  </div>
                </div>
