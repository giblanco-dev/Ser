...
require_once '../../app/logic/conn_recovery.php';
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <div class="row">
        <div class="col s12 center-align">
            <h5>Cortes de Caja <strong>(Recovery)</strong></h5>
        </div>
        <div class="row">
                        ...
                        <table class="centered">
                            ...
                            <tbody>
                                ...
                                while($row_corte = mysqli_fetch_assoc($res_cortes)){
                                    ...
                                    <td><a class="center-align" href="detalle_corte_recovery.php?idcorte='.$row_corte["id_corte"].'" class="secondary-content" target="blank"><i class="material-icons">attach_money</i></a></td>
                                    </tr>
                                    ';
                                }
                                ?>
